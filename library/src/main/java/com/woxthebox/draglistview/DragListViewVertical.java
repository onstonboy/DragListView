...
public class DragListViewVertical extends FrameLayout {
    ...
    public DragListViewVertical(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DragListViewVertical(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public DragItemVerticalAdapter getAdapter() {
        if (mRecyclerView != null) {
            return (DragItemVerticalAdapter) mRecyclerView.getAdapter();
        }
        return null;
    }

    public void setAdapter(DragItemVerticalAdapter adapter, boolean hasFixedItemSize) {
