...
public class DragItemVerticalRecyclerView extends RecyclerView implements AutoScroller.AutoScrollListener {
    ...
    public DragItemVerticalRecyclerView(Context context) {
        super(context);
        init();
    }

    public DragItemVerticalRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        init();
    }

    public DragItemVerticalRecyclerView(Context context, AttributeSet attrs, int defStyle) {
